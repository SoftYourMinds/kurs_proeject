...
<nav aria-label="breadcrumb" id ="zag">
   ...
   <li class="breadcrumb-item"><a href="adminka.php">Все товары</a></li>
    <li class="breadcrumb-item active" aria-current="page">Компьютерное оборудование</li>
  </ol>
 </nav>
...
<h2 id ="zag">Компьютерное оборудование</h2>
    <thead>
    <tr>
	    <th scope="col">#</th>
...
<?php 
	$sql = 'SELECT * FROM `goods` WHERE `catid` = 4';
